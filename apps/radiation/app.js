...
//********** alte funktion geht, muss aber gesamte datei erst lesen *************
        try {
...
/* --------------- geht nicht --------         
        ...
        if (!this.fileExists(filename)) {
            ...
            // EFFIZIENTES Anhängen mit Storage.open
...
//-------------- Anzahl der Minutenwerte --------   
    ...
    if (( GMZ_Minuten_zaehler > GMZ_Minuten_zaehler_merker) || (alles_darstellen == true ))
    {
...
//vati          
      ...
      //       status_anzeige_anzeigen();
             // gmz_anzeige ( 9999);
/*             
             if ((Alpha_Stick_RSSI_merker != Alpha_Stick_RSSI) || (GMZ_Minuten_zaehler_merker !=GMZ_Minuten_zaehler))
             {
